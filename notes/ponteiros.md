...
Declaração de tipos
govar p *int       // ponteiro para int, valor zero é nil
...
gofunc novaPersona(nome string) *Pessoa {
...
SituaçãoUsar ponteiro?Modificar argumento dentro de função✅ SimStruct grande (evitar cópia)✅ SimMétodos que mutam o receiver✅ SimValor simples só para leitura❌ Não precisaIndicar ausência de valor (nil)✅ Sim
go// Sem ponteiro — copia a struct
